    ...
    return (
      <div className="contact__container">
        ...
        <div className="contact__logo_container">
          <a className='contact__logo' href="https://www.linkedin.com/in/hodoabdirizak/" target="_blank" rel="noreferrer">
            <img className='contact__logo' src={linkedin_logo} alt="" width="60" height="60"></img>
          </a>
          <a className='contact__logo' href="mailto:hodo.abdirizak@torontomu.ca" target="_blank" rel="noreferrer">
            <img className='contact__logo' src={email_logo} alt="" width="60" height="60"></img>
          </a>
          <a className='contact__logo' href="https://github.com/hodoabdirizak" target="_blank" rel="noreferrer">
            <img className='contact__logo' src={github_logo} alt="" width="60" height="60"></img>
          </a>
